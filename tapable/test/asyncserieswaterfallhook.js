 ...
 * @Descripttion: 
 * @Author: lhuanyu
 * @Date: 2020-04-20 13:55:43
 * @LastEditors: lhuanyu
 * @LastEditTime: 2020-04-20 14:05:05
 */
let AsyncSeriesWaterfallHook = require('../lib/AsyncSeriesWaterfallHook.js')
let aph = new AsyncSeriesWaterfallHook(['a', 'b'])
...
let aph1 = new AsyncSeriesWaterfallHook(['a', 'b'])
...
let aph2 = new AsyncSeriesWaterfallHook(['a', 'b'])
