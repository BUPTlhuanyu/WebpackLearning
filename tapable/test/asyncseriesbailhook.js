 ...
 * @Descripttion: 
 * @Author: lhuanyu
 * @Date: 2020-04-20 13:55:42
 * @LastEditors: lhuanyu
 * @LastEditTime: 2020-04-20 13:58:28
 */
let AsyncSeriesBailHook = require('../lib/AsyncSeriesBailHook.js')
let aph = new AsyncSeriesBailHook(['a', 'b'])

aph.tapAsync({ name: '1' }, () => { console.log(1) })
aph.tapAsync({ name: '2' }, () => { console.log(2)})
...
let aph1 = new AsyncSeriesBailHook(['a', 'b'])
aph1.tap({ name: '1' }, () => { console.log(1) })
aph1.tap({ name: '2' }, () => { console.log(2)})
...
let aph2 = new AsyncSeriesBailHook(['a', 'b'])
